    ...
    return(
        <div className="lg:px-36 md:w-full px-5 transition duration-300" style={{ transform: (`translateX(-${100*steps}%)`) }}>
            ...
            <div className="xl:px-56 xl:mx-auto md:px-20 relative flex flex-col items-center justify-center" style={{ maxWidth: "1000px" }}>
                ...
                <div className="lg:justify-center flex relative w-full h-80 justify-between items-start mb-16">
                    <span className={"lg:-left-5 absolute transform -translate-y-1/2 -left-0 top-1/2 text-4xl cursor-pointer transition duration-300 font-light " + (customizing[0] && "opacity-100 delay-200" || "opacity-0")}>{"<"}</span>
                    <span className={"lg:-right-5  absolute transform -translate-y-1/2 -right-0 top-1/2 text-4xl cursor-pointer transition duration-300 font-light " + (customizing[0] && "opacity-100 delay-200" || "opacity-0")}>{">"}</span>
                    <div className="lg:absolute -left-28">
                    ...
                    <div></div>
                    <img className={"w-36 mr-5 lg:transform-none transition duration-300 transform " + (customizing[0] && "absolute -translate-x-1/2 left-1/2")} src={character} />
                </div>
