    ...
    return(
        <div className="profile-container lg:flex hidden flex-col justify-center items-center border-2 border-gray-200 bg-white pt-8 self-start rounded-lg">
            ...
            <div className="w-full px-2">
                <div className="grid grid-cols-3 rounded-md bg-lightOrange bg-opacity-10 w-full px-2 py-2 text-center">
                    <div className="point">
                        <div className="text-orange font-semibold">{profile.point}</div>
                        <div className="text-xs">คะแนนสะสม</div>
                    </div>
                    <div className="orders">
                        <div className="text-orange font-semibold">{profile.orders}</div>
                        <div className="text-xs">คำสั่งซื้อรวม</div>
                    </div>
                    <div className="budget">
                        <div className="text-orange font-semibold">{profile.budget}</div>
